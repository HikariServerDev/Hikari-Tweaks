...
**A client-side Fabric utility mod for Minecraft 1.18.2**, developed at [Hikari Server (光鯖)](https://hikariserver.com). Provides a fully customizable custom scoreboard HUD (paired with HikariScoreBoard) plus a set of quality-of-life features.
